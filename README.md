...
**TOR 5.0.0** is an updated build of The Other Roles for [Among Us](https://store.steampowered.com/app/945360/Among_Us) which adds many new roles, new [Settings](#settings) and new [Custom Hats](#custom-hats) to the game.
Even more roles are coming soon. :)

This repository/package includes the mod plugin and BepInEx runtime files needed to load it. It does not include Among Us game files.
...
| [Witch](#witch) | [Tracker](#tracker) | [Leech](#leech) | [Armored](#armored) |
| [Ninja](#ninja) | [Snitch](#snitch) | [Collector](#collector) |  |
...
|----------|-------------|-----------------|
| 2024.10.29| v5.0.0| This repository/package |
...
- Added Sleepwalker, Leech, Collector, Locksmith and Archivist.
- Gambler removed.
- Collector reworked: automatically receives a random Impostor, Jackal or Sidekick target at game start and wins if that target dies by someone else.
- Optional Role Draft mode.
...
## Sleepwalker
### **Team: Crewmates**
The Sleepwalker is a Crewmate who wakes up in a random room after meetings. This creates alibi and positioning dynamics without giving the role a direct kill ability.
...
## Leech
### **Team: Neutral**
The Leech receives a host as a target. The Leech wins if the host wins at the end, so the Leech has to support the host indirectly and stay alive.
...
## Collector
### **Team: Neutral**
The Collector is assigned a random target among Impostor, Jackal or Sidekick at game start. The Collector wins if that target dies by someone else. The Collector does not choose the target manually.

### Game Options
| Name | Description |
|----------|:-------------:|
| Collector Spawn Chance | -
-----------------------

## Locksmith
### **Team: Crewmates**
The Locksmith can open locked doors instantly a limited number of times. This counters sabotage and Impostor door control.

### Game Options
| Name | Description |
|----------|:-------------:|
| Locksmith Spawn Chance | -
| Locksmith Max Uses | Number of instant door opens
-----------------------

## Archivist
### **Team: Crewmates**
The Archivist automatically saves a short history after each meeting. The history includes who died since the last meeting, how many kills occurred and whether at least one neutral role is still alive.

### Game Options
| Name | Description |
|----------|:-------------:|
| Archivist Spawn Chance | -
-----------------------
...
## Snitch
### **Team: Crewmates**
The Snitch receives early information on a killing role after completing 50% of their tasks. Sheriff is excluded from this early killing-role information.\
After completing 75% of their tasks, the Snitch gains armor. The armor blocks one kill attempt and breaks afterward.\
...
- Armor protects against one kill attempt only
...
| Early Info Task Progress | 50% tasks completed
| Armor Task Progress | 75% tasks completed
...
Bundled third-party runtime files are documented separately:

- BepInEx is licensed under LGPL-2.1-or-later.
- Unity Doorstop, included as `winhttp.dll`, is licensed under LGPL-2.1-or-later.
- .NET runtime files are licensed under the MIT license.
- See `THIRD_PARTY_NOTICES.md`, `LICENSES/BepInEx-LGPL-2.1.txt` and `LICENSES/dotnet-runtime-MIT.txt`.
