...
<color=#FF0000>edited by BosuFPS</color>
...
License: TheOtherRoles is licensed under the [https://github.com/TheOtherRolesAU/TheOtherRoles?tab=GPL-3.0-1-ov-file#readme]GPLv3[]
            ...
            // Add "edited by BosuFPS" on main menu
            var rightPanel = GameObject.Find("RightPanel");
            if (rightPanel != null) {
                var editorText = new GameObject("EditedByText").AddComponent<TMPro.TextMeshPro>();
                editorText.transform.SetParent(rightPanel.transform, false);
                editorText.fontSize = 0.65f;
                editorText.fontStyle = TMPro.FontStyles.Bold;
                editorText.alignment = TMPro.TextAlignmentOptions.Center;
                editorText.text = "<color=#FF0000>edited by BosuFPS</color>";
                editorText.transform.localPosition = new Vector3(0f, -3.2f, 5f);
            }
        }
