...
namespace TheOtherRoles
{
    public class RoleInfo {
        ...
        public static RoleInfo sleepwalker = new RoleInfo("Sleepwalker", Sleepwalker.color, "Wake up somewhere else after meetings", "Wake up elsewhere", RoleId.Sleepwalker);
        public static RoleInfo leech = new RoleInfo("Leech", Leech.color, "Win with your host", "Win with your host", RoleId.Leech, true);
        public static RoleInfo collector = new RoleInfo("Collector", Collector.color, "Your target is a killer. Collect if they die by someone else", "Collect a killer's death", RoleId.Collector, true);
        public static RoleInfo locksmith = new RoleInfo("Locksmith", Locksmith.color, "Open locked doors", "Open locked doors", RoleId.Locksmith);
        public static RoleInfo archivist = new RoleInfo("Archivist", Archivist.color, "Archive meeting history", "Archive history", RoleId.Archivist);
        ...
        public static List<RoleInfo> getRoleInfoForPlayer(PlayerControl p, bool showModifier = true) {
            ...
            if (showModifier) {
                ...
                if (p == Armored.armored || (p == Snitch.snitch && Snitch.hasArmor)) infos.Add(armored);
            ...
            if (p == Sleepwalker.sleepwalker) infos.Add(sleepwalker);
            if (p == Locksmith.locksmith) infos.Add(locksmith);
            if (p == Archivist.archivist) infos.Add(archivist);
            if (p == Leech.leech) infos.Add(leech);
            if (p == Collector.collector) infos.Add(collector);
