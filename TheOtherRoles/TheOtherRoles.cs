...
namespace TheOtherRoles
{
    ...
    public static class TheOtherRoles
    {
        ...
        public static void clearAndReloadRoles() {
            ...
            Leech.clearAndReload();
            Collector.clearAndReload();
            Locksmith.clearAndReload();
            Archivist.clearAndReload();
    ...
    public static class Snitch {
        ...
        public static bool hasKillerInfo = false;
    ...
    public static class Sleepwalker {
        ...
        public static Color color = new Color32(145, 180, 255, byte.MaxValue);
    ...
    public static class Leech {
        public static PlayerControl leech;
        public static PlayerControl target;
        public static Color color = new Color32(126, 82, 170, byte.MaxValue);
    ...
    public static class Collector {
        ...
        public static PlayerControl target;
        public static Color color = new Color32(90, 120, 90, byte.MaxValue);

        public static bool targetWasCollected() {
            if (collector == null || target == null) return false;
            DeadPlayer deadTarget = GameHistory.deadPlayers.FirstOrDefault(x => x.player != null && x.player.PlayerId == target.PlayerId);
            return deadTarget != null && (deadTarget.killerIfExisting == null || deadTarget.killerIfExisting.PlayerId != collector.PlayerId);
        }
    ...
    public static class Locksmith {
        ...
        public static Color color = new Color32(105, 210, 190, byte.MaxValue);
        public static int remainingUses = 1;

        private static Sprite buttonSprite;
        public static Sprite getButtonSprite() {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("TheOtherRoles.Resources.CloseVentButton.png", 115f);
            return buttonSprite;
        }

        public static void clearAndReload() {
            locksmith = null;
            remainingUses = Mathf.RoundToInt(CustomOptionHolder.locksmithUses.getFloat());
        }
    }

    public static class Archivist {
        public static PlayerControl archivist;
        public static Color color = new Color32(205, 180, 100, byte.MaxValue);
        public static int lastKnownDeadCount = 0;

        public static void clearAndReload() {
            archivist = null;
            lastKnownDeadCount = 0;
        }
    }
